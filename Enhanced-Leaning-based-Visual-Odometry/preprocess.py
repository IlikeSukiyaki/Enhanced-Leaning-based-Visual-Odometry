...
def create_pose_data():
	info = {'00': [0, 4540], '01': [0, 1100], '02': [0, 4660], '03': [0, 800], '04': [0, 270], '05': [0, 2760], '06': [0, 1100], '07': [0, 1100], '08': [1100, 5170], '09': [0, 1590], '10': [0, 1200], '30': [0, 630], '31': [0, 630], '32': [0, 630]}
	start_t = time.time()
...
if __name__ == '__main__':
	...
	for folder in train_video:
		image_path_list += glob.glob('/home/yifeng/Desktop/DeepVO/DeepVO-pytorch/KITTI/images/{}/*.png'.format(folder))
		# image_path_list += glob.glob("/home/yifeng/Desktop/DeepVO/DeepVO-pytorch/KITTI/images")
		print(folder,"\n##############",image_path_list)
